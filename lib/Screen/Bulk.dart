...
import 'package:alfarouk_mart/Screen/Sale_Section.dart';
...
class Bulk extends StatefulWidget {
  const Bulk({Key? key}) : super(key: key);

  @override
  _BulkState createState() => _BulkState();
}

class _BulkState extends State<Bulk>
    with AutomaticKeepAliveClientMixin<Bulk>, TickerProviderStateMixin {
        ...
        child: InkWell(
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                          ...
                          child: Hero(
                              ...
                              child:  networkImageCommon(
                                  saleList[secPos].productList![index].image!, width, false,
                                  height: double.maxFinite,
                                  width: double
                                      .maxFinite)
                            /*CachedNetworkImage(
          ...
          onTap: () {
            ...
            Navigator.push(
              ...
              PageRouteBuilder(
                  pageBuilder: (_, __, ___) => ProductDetail(
                      id: model.id!, secPos: secPos, index: index, list: false)),
            );
          },
        ),
      );
