...
import 'package:alfarouk_mart/Screen/SignInUpAcc.dart';
...
class _GettingStartedScreenState extends State<IntroSlider>
  ...
  skipBtn() {
    return _currentPage == 0 || _currentPage == 1
        ...
        : Container(
            margin: const EdgeInsetsDirectional.only(top: 22.0),
            height: 15,
          );
  }
