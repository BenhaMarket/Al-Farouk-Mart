...
import 'package:alfarouk_mart/Screen/PromoCode.dart';
...
import 'package:alfarouk_mart/Screen/Customer_Support.dart';
import 'package:alfarouk_mart/Screen/MyTransactions.dart';
import 'package:alfarouk_mart/Screen/ReferEarn.dart';
import 'package:alfarouk_mart/Screen/SendOtp.dart';
...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  _getSaved() async {
    ...
    selectLan = langCode.indexOf(getlng == '' ? "ar" : getlng);
  ...
  Widget getUserImage(String profileImage, VoidCallback? onBtnSelected) {
    return InkWell(
        ...
        onTap: () {
          if (mounted) {
            if (CUR_USERID != null) onBtnSelected!();
          }
        });
  }
