...
import 'package:alfarouk_mart/Model/FlashSaleModel.dart';
...
import 'package:alfarouk_mart/Screen/FlashSaleProductList.dart';
import 'package:alfarouk_mart/Screen/MultipleTimer.dart';
            ...
            child: Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10.0), color: Theme.of(context).cardColor),
                child: Column(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ClipRRect(
                              ...
                              child: networkImageCommon(saleList[index].image!, 180, true,
                                  height: 180,
                                  width: double
              ...
              return Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (data[index].style == "default" || data[index].style == "style_1") {
                      context.read<OfferImagesProvider>().setOfferCurSlider(index);
                    }
  ...
  Widget imageSliderWidget(int i, List<SliderImages> data) {
    ...
    return data[i].style == "default" || data[i].style == "style_1"
        ...
        : data[i].style == "style_2"
            ? GridView.count(
                padding: const EdgeInsetsDirectional.only(top: 10, start: 7, end: 7),
                crossAxisCount: 3,
                shrinkWrap: true,
                          ...
                          return InkWell(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: networkImageCommon(
                                      data[i].offerImages![index].image!, deviceWidth! / 2, true,
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                      borderRadius: BorderRadius.circular(10),
                                      child: networkImageCommon(data[i].offerImages![index].image!,
                                          deviceWidth! / 2, true,
  ...
  void _animateSlider() {
    if (mounted) {
      Future.delayed(const Duration(seconds: 4)).then((_) {
        int nextPage =
            _controller.hasClients ? _controller.page!.round() + 1 : _controller.initialPage;
    ...
    try {
      apiBaseHelper.postAPICall(getFlashSaleApi, {}).then((getdata) {
        ...
        if (!error) {
          ...
          List<FlashSaleModel> saleList =
              (data as List).map((data) => FlashSaleModel.fromJson(data)).toList();
      ...
      apiBaseHelper.postAPICall(getOfferImageApi, {}).then((getdata) {
        ...
        if (!error) {
          ...
          List<SliderImages> offerList =
              (data as List).map((data) => SliderImages.fromJson(data)).toList();
