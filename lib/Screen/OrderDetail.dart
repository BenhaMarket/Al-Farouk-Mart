...
import 'package:alfarouk_mart/Model/Order_Model.dart';
import 'package:alfarouk_mart/Screen/Review_Gallary.dart';
import 'package:alfarouk_mart/Screen/Review_Preview.dart';
...
class StateOrder extends State<OrderDetail>
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                getTranslated(context, 'WOULD_LIKE_TO_RETURN_PRO_LBL')!,
                                                style: TextStyle(
                                                    color: Theme.of(context)
                                                        .colorScheme
                                                        .fontColor),
  ...
  Future getDownloadLink(String orderItemId) async {
    try {
      ...
      var parameter = {'order_item_id': orderItemId, USER_ID: CUR_USERID};
