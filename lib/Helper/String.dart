...
final Uri getMidtransTransactionStatusApi = Uri.parse('${baseUrl}get_midtrans_transaction_status');
final Uri midtransBebhookApi = Uri.parse('${baseUrl}midtrans_webhook');
final Uri createMidtransTransactionApi = Uri.parse('${baseUrl}create_midtrans_transaction');
